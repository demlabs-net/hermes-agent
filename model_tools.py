...
def _compute_tool_definitions(enabled_toolsets: Optional[List[str]] = None, disabled_toolsets: Optional[List[str]] = None,
                              ...
                              publish_resolved_names: bool = True) -> List[Dict[str, Any]]:
    """Uncached implementation; scoped catalog probes may avoid publishing globals."""
    ...
    if publish_resolved_names:
        global _last_resolved_tool_names
        _last_resolved_tool_names = resolved_tool_names
