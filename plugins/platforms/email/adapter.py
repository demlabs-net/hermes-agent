...
class EmailAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._from_name = setting("EMAIL_FROM_NAME", "from_name").strip()
    ...
    def _new_reply(self, to_addr: str, body: str, reply_to_msg_id: Optional[str] = None, *,
        ...
        from_header = f"{self._from_name} <{self._address}>" if self._from_name else self._address
        for key, value in (("From", from_header), ("To", to_addr), ("Subject", subject), *threading,
