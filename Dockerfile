...
# Only the two static uv binaries are copied from this stage. Using the full
# Python/Trixie variant made a cache-cold agent rebuild download hundreds of
# megabytes that never reached the final image.
