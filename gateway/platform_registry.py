...
class PlatformEntry:
    ...
    # The standalone sender owns the complete host-driven text+media envelope.
    # Media requests bypass a live text-only adapter and are delivered once,
    # unsplit, through this sender.
